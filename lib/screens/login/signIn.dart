...
import 'package:new_crypto_app/screens/login/signUp.dart';
import 'package:new_crypto_app/services/firebase_auth_methods.dart';
import 'package:new_crypto_app/widgets/f&g_button.dart';
import 'package:new_crypto_app/widgets/loading.dart';
...
// 1. This method call when app in terminated state and you get a notification
  ...
  Widget signInLayout(double height, bool signInType, bool isVisible) {
    return SizedBox(
      height: height / 2.2,
      child: LayoutBuilder(builder: (context, constraints) {
        return Column(
